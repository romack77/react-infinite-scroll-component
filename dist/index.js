...
var InfiniteScroll = /** @class */ (function(_super) {
  ...
  function InfiniteScroll(props) {
    ...
    _this.onScrollListener = function(event) {
      ...
      var atBottom = _this.isElementAtBottom(
        target,
        _this.props.scrollThreshold
      );
  ...
  InfiniteScroll.prototype.render = function() {
    ...
    var outerDivStyle = this.props.outerDivStyle;
    if (this.props.pullDownToRefresh && this.props.height) {
      outerDivStyle = __assign({ overflow: 'auto' }, this.props.outerDivStyle);
    }
